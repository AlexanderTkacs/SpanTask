...
public class AnswerScreen4Span extends JFrame {
	...
	//color answer
	private int answerBoxWidth = (int)(main.width*0.14);
	private int answerBoxHeight = (int)(main.height*0.25);
	
	private int answer1BoxX = (int)(main.width*0.22);
	private int answer1BoxY = (int)(main.height*0.55);
	
	private int answer2BoxX = (int)(main.width*0.42);
	private int answer2BoxY = (int)(main.height*0.55);
	
	private int answer3BoxX = (int)(main.width*0.62);
	private int answer3BoxY = (int)(main.height*0.55);
	
	private int answer4BoxX = (int)(main.width*0.82);
	...
	public AnswerScreen4Span(int numLeft, boolean visual) {
		...
		sumbitButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(visual)
				{
					...
					if(numLeft > 0)
					{
						new ColorTest(4, numLeft-1).setVisible(true);
						dispose();
					}
					...
					else
					{
						...
						new ColorTest(5, main.SPANAMOUNT).setVisible(true);
						//main.makeScreen(3);
						dispose();
					}
				}
				else
				{
					if(numLeft > 0)
					{
						new AudioTest(4, numLeft-1).setVisible(true);
						dispose();
					}
					else
					{
						//main.updateAudioScore();
						new AudioTest(5, main.SPANAMOUNT).setVisible(true);
						//main.makeScreen(3);
						dispose();
					}
				}
