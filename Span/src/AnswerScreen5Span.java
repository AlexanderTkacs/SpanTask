...
public class AnswerScreen5Span extends JFrame {
	private int selectedColor = -1;
	private boolean even;
	private int[] colors = {-1, -1, -1, -1, -1};
	...
	//color answer
	private int answerBoxWidth = (int)(main.width*0.12);
	...
	private int answer2BoxX = (int)(main.width*0.36);
	private int answer2BoxY = (int)(main.height*0.55);
	
	private int answer3BoxX = (int)(main.width*0.52);
	private int answer3BoxY = (int)(main.height*0.55);
	
	private int answer4BoxX = (int)(main.width*0.68);
	private int answer4BoxY = (int)(main.height*0.55);
	
	private int answer5BoxX = (int)(main.width*0.84);
	...
	public AnswerScreen5Span(int numLeft, boolean visual) {
		...
		sumbitButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(visual)
				{
					...
					if(numLeft > 0)
					{
						new ColorTest(5, numLeft-1).setVisible(true);
						dispose();
					}
					...
					else
					{
						...
						new ColorTest(6, main.SPANAMOUNT).setVisible(true);
						//main.makeScreen(3);
						dispose();
					}
				}
				else
				{
					if(numLeft > 0)
					{
						new AudioTest(5, numLeft-1).setVisible(true);
						dispose();
					}
					else
					{
						//main.updateAudioScore();
						new AudioTest(6, main.SPANAMOUNT).setVisible(true);
						//main.makeScreen(3);
						dispose();
					}
				}
