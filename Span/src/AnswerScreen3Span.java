...
public class AnswerScreen3Span extends JFrame {
	...
	//color answer
	private int answerBoxWidth = (int)(main.width*0.2);
	private int answerBoxHeight = (int)(main.height*0.3);
	
	private int answer1BoxX = (int)(main.width*0.25);
	private int answer1BoxY = (int)(main.height*0.55);
	
	private int answer2BoxX = (int)(main.width*0.5);
	private int answer2BoxY = (int)(main.height*0.55);
	
	private int answer3BoxX = (int)(main.width*0.75);
	...
	public AnswerScreen3Span(int numLeft, boolean visual) {
		...
		sumbitButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(visual)
				{
					...
					if(numLeft > 0)
					{
						new ColorTest(3, numLeft-1).setVisible(true);
						dispose();
					}
					//if need to increase span length
					else
					{
						new ColorTest(4, main.SPANAMOUNT).setVisible(true);
						dispose();
					}
				}
				else
				{
					if(numLeft > 0)
					{
						new AudioTest(3, numLeft-1).setVisible(true);
						dispose();
					}
					else
					{
						new AudioTest(4, main.SPANAMOUNT).setVisible(true);
						dispose();
					}
				}
